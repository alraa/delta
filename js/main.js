$( document ).ready(function() {
	...
	// Удаление элемента при клику на крестик страница Order
	$('.js-cross').click(function(event) {
		event.preventDefault();

		$(this).parents('.docs-wrapper').remove();
	});
	...
	$('.order-radio').styler();
	$('.order-file').styler({
		fileBrowse: 'Прикрепить документ',
	});
	$('.balance-file').styler({
		fileBrowse: 'Прикрепить подтверждающий документ',
	});
